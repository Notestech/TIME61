...
{
    TIMEAlbumCollectionViewController *albumViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"AlbumCollection"];

    albumViewController.view.backgroundColor = [UIColor whiteColor];
